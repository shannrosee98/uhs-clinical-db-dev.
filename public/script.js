...
var emergencyData = {
  'cardiac-arrest': {
    ...
    priorities: ['Check safety and responsiveness', 'Call for help / activate ALS', 'Start CPR 30:2', 'Attach AED/defibrillator', 'Minimise interruptions to chest compressions', 'Consider reversible causes (4Hs + 4Ts)'],
    assessment: ['Unresponsive', 'Not breathing or agonal gasping', 'No signs of life', 'Check rhythm - shockable or non-shockable'],
    rp: ['/me checks the patient for responsiveness by gently shaking and shouting', '/me opens the airway using head-tilt chin-lift and checks for breathing', '/me begins chest compressions at a rate of 100-120 per minute', '/me ventilates using BVM with 15L oxygen attached'],
    questions: ['How long has the patient been unresponsive?', 'Did anyone witness the arrest?', 'Has CPR been started already?']
  },
  'major-trauma': {
    title: '🛡 Major Trauma',
    priorities: ['Scene safety', 'Control catastrophic haemorrhage', 'ABCDE assessment', 'Spinal precautions', 'Rapid transport to trauma centre'],
    assessment: ['Mechanism of injury', 'Catastrophic haemorrhage control', 'Airway with C-spine', 'Breathing and chest assessment', 'Circulation and haemorrhage control'],
    rp: ['/me confirms the scene is safe before approaching', '/me checks for catastrophic external bleeding and applies direct pressure', '/me manually stabilises the patient\'s head and neck', '/me assesses the patient\'s chest for open wounds or deformity'],
    questions: ['What happened?', 'Where is your pain?', 'Can you feel your hands and feet?', 'Do you have any medical conditions?']
  },
  'chest-pain': {
    title: '❤️ Chest Pain',
    priorities: ['Assess ABCDE', '12-lead ECG within 10 minutes', 'Aspirin 300mg if no contraindications', 'GTN spray if prescribed', 'Oxygen if hypoxic only', 'Pain assessment'],
    assessment: ['SOCRATES pain history', 'ECG interpretation', 'Heart rate and BP', 'SpO2', 'Cardiac auscultation'],
    rp: ['/me sits the patient upright and takes a SOCRATES pain history', '/me obtains a 12-lead ECG and examines the trace', '/me checks the patient\'s BP before offering GTN spray'],
    questions: ['Can you describe the pain?', 'When did it start?', 'Does it go anywhere else?', 'Have you taken anything for it?', 'Do you have any history of heart problems?']
  },
  'stroke': {
    title: '🧠 Stroke',
    priorities: ['FAST assessment', 'Time of onset', 'ABC assessment', '12-lead ECG', 'Blood glucose', 'Thrombolysis window'],
    assessment: ['Facial droop', 'Arm weakness', 'Speech difficulty', 'Time of onset', 'BP and HR', 'Blood glucose'],
    rp: ['/me assesses the patient using the FAST stroke scale', '/me checks for facial droop by asking the patient to smile', '/me checks arm strength by asking the patient to raise both arms'],
    questions: ['What time did these symptoms start?', 'Can you lift both arms for me?', 'Can you repeat this sentence?', 'Do you have any weakness or numbness?']
  },
  'anaphylaxis': {
    title: '🦯 Anaphylaxis',
    priorities: ['Remove trigger if possible', 'Call for help', 'IM Adrenaline 500mcg (0.5mL of 1:1000)', 'ABC assessment', 'Position patient appropriately'],
    assessment: ['Airway compromise - swelling, stridor', 'Breathing - wheeze, respiratory distress', 'Circulation - hypotension, tachycardia', 'Skin - urticaria, erythema, angioedema'],
    rp: ['/me recognises the signs of anaphylaxis and calls for immediate assistance', '/me prepares 1:1000 adrenaline and administers IM into the anterolateral thigh', '/me monitors the patient\'s airway and breathing for signs of compromise'],
    questions: ['What did you eat or come into contact with?', 'Do you have any known allergies?', 'Do you have an adrenaline auto-injector?', 'Have you had a reaction like this before?']
  },
  'seizure': {
    title: '🧢 Seizure',
    priorities: ['Time the seizure', 'Protect the airway', 'Move hazards away', 'Cushion the head', 'Note duration', 'Call for help if >5 minutes'],
    assessment: ['Seizure type and duration', 'Airway and breathing', 'Post-ictal state', 'Blood glucose', 'Injury assessment'],
    rp: ['/me notes the time the seizure started and clears hazards from the area', '/me cushions the patient\'s head without restraining their movements', '/me assesses the patient\'s airway and breathing once the seizure has stopped'],
    questions: ['Has this happened before?', 'Do you have epilepsy?', 'Have you missed any medication?', 'Did you hit your head?']
  },
  'respiratory': {
    title: '💨 Respiratory Distress',
    priorities: ['Airway assessment', 'Position upright', 'Oxygen if hypoxic', 'Nebulised medication if asthmatic/COPD', 'Monitor SpO2 continuously'],
    assessment: ['Respiratory rate and effort', 'SpO2', 'Auscultation - wheeze, crackles, silent chest', 'Ability to speak in full sentences', 'Accessory muscle use'],
    rp: ['/me positions the patient upright and assesses their respiratory effort', '/me attaches the pulse oximeter and applies oxygen if hypoxic', '/me listens to the patient\'s chest with a stethoscope'],
    questions: ['When did the breathing difficulty start?', 'Do you have asthma or COPD?', 'Have you used your inhaler?', 'Can you speak in full sentences?']
  },
  'haemorrhage': {
    title: '🩸 Major Haemorrhage',
    priorities: ['Direct pressure on wound', 'Tourniquet if life-threatening limb bleed', 'Haemostatic dressing if available', 'IV access and fluid resuscitation', 'Pelvic binder if suspected pelvic fracture'],
    assessment: ['Source and severity of bleeding', 'Signs of shock', 'Pulse and BP', 'Capillary refill time', 'Skin colour and temperature'],
    rp: ['/me exposes the wound and applies direct pressure with gauze', '/me applies a tourniquet to the affected limb and notes the time', '/me gains IV access and prepares for fluid resuscitation'],
    questions: ['Where are you bleeding from?', 'Are you on any blood thinning medication?', 'Do you feel dizzy or lightheaded?']
  },
  'sepsis': {
    title: '🦠 Sepsis',
    priorities: ['Recognise red flags', 'Sepsis Six within 1 hour', 'Blood cultures', 'IV antibiotics', 'IV fluids', 'Monitor observations'],
    assessment: ['Temperature', 'Heart rate', 'Respiratory rate', 'Blood pressure', 'Mental status', 'Signs of infection source'],
    rp: ['/me assesses for sepsis red flags including altered mental status and fever', '/me gains IV access and takes blood cultures before antibiotics'],
    questions: ['Do you feel feverish or have you been shivering?', 'Have you had any recent infections?', 'Have you been feeling generally unwell?']
  },
  'overdose': {
    title: '💊 Overdose',
    priorities: ['ABC assessment', 'Check consciousness level', 'Identify substance if possible', 'Naloxone if opioid suspected', 'Monitor respiratory rate'],
    assessment: ['Level of consciousness (AVPU/GCS)', 'Respiratory rate and depth', 'Pupil size and reaction', 'Signs of specific toxidromes'],
    rp: ['/me assesses the patient\'s airway and breathing, checking respiratory rate', '/me checks pupil size and reaction to light', '/me prepares naloxone if opioid overdose is suspected'],
    questions: ['What did you take?', 'How much did you take?', 'When did you take it?', 'Did you take anything else including alcohol?']
  }
};
...
function activateEmergency(key) {
  ...
  document.getElementById('emergency-priorities').innerHTML = '<ul>' + (data.priorities || []).map(function(p) { return '<li>' + escapeHtml(p) + '</li>'; }).join('') + '</ul>';
  document.getElementById('emergency-assessment').innerHTML = '<ul>' + (data.assessment || []).map(function(p) { return '<li>' + escapeHtml(p) + '</li>'; }).join('') + '</ul>';
  document.getElementById('emergency-rp').innerHTML = (data.rp || []).map(function(r, i) {
    return '<div class="scene-action-row"><span class="content">' + escapeHtml(r) + '</span><button class="act-copy" onclick="copyTextInline(\'' + escapeHtml(r) + '\')">Copy</button></div>';
  }).join('') || '<p class="muted">No RP actions listed.</p>';
  document.getElementById('emergency-questions').innerHTML = (data.questions || []).map(function(q) {
    return '<div class="tts-card"><div class="tts-command">/tts ' + escapeHtml(q) + '</div><button class="act-copy" style="margin-top:6px" onclick="copyTextInline(\'/tts ' + escapeHtml(q) + '\')">Copy /tts</button></div>';
  }).join('') || '<p class="muted">No questions listed.</p>';
